...
/**
 * Renderer for showing Sidelivechat in CMSMain
 * 
 * @package livechat
 */
class SideLiveChatView extends ViewableData {
	...
	public function group() {
		return _t('SideLiveChat.OtherGroupTitle', "Other");
	}
...
class SideLiveChatWrapper extends SS_Report {
